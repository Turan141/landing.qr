...
const Header = () => {
	...
	return (
        ...
        >
			<div className={`container mx-auto px-4 md:px-6 transition-all duration-300 flex items-center justify-between ${scrolled ? 'h-16' : 'h-20'}`}>
				<div className='flex items-center gap-3'>
					...
					<div className="flex flex-col">
                        ...
                        <span className='text-[10px] text-gray-400 uppercase tracking-widest mt-0.5 font-medium'>from IMPAYA</span>
                    </div>
				</div>
