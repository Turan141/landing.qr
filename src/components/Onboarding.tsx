...
const StepCard = ({ number, text }: { number: number; text: string }) => (
	<div className='bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm flex flex-col items-start h-full min-h-[200px] hover:shadow-md transition-shadow'>
		<div className='w-8 h-8 rounded-full bg-black text-white flex items-center justify-center font-bold text-sm mb-6'>
			{number}
		</div>
